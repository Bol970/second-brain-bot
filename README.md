...
Не коммить реальные API-ключи. Telegram bot token, Tavily и OpenRouter держи в Cloudflare Secrets. Если токен где-то засветился в чате или логе — перевыпусти его.
